...
The Pound-Drever-Hall (PDH) method will be used for length control. The IO EOM located in the PSL will be used for the modulator, and the reflection from the JAC will be directed to the ISCT1/IOT1 and sense the signal with the LSC PD located on the table. The digital servo will be used for the control. For the shot noise calculation, 2\% of mode-mismatching is assumed.
